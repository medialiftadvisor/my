...
def calculate_true_ascendant_detailed(dt_str, lat, lng, ayanamsa='1'):
    ...
    return {
        ...
        "declination_mag": round(dec_abs, 4),
        "altitude": alt_str,
        "azimuth": az_str,
...
def normalize_positions_helper(planets, provider, ayanamsa, dt, lat, lng):
    ...
    asc_obj = {
        ...
        "declination": asc_details.get("declination", "00° 00'"),
        "declination_deg": asc_details.get("declination_deg", 0.0),
        "declination_mag": asc_details.get("declination_mag", 0.0),
...
def get_mock_chart(dt, lat, lng, ayanamsa='0', custom_positions=None, style='default'):
    ...
    for p in positions:
        ...
        # Use sidereal longitude for Vedic mode (matches table), tropical otherwise
        if ayanamsa == '1':
